...
namespace Grynwald.MdDocs.ApiReference.Test.Model
{
    ...
    {
        private static readonly TypeId s_TypeId_Class1 = new SimpleTypeId("Grynwald.MdDocs.ApiReference.Test.Model.TestData", "Class1");
        ...
        private const string s_SampleSourceCode = @"
            ...
            namespace Grynwald.MdDocs.ApiReference.Test.Model.TestData
            {
                public class Class1
                {
                    public void Method1()
