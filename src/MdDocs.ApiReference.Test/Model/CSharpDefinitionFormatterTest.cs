...
namespace Grynwald.MdDocs.ApiReference.Test.Model
{
    ...
    /// </summary>
    public class CSharpDefinitionFormatterTest : DynamicCompilationTestBase
    {
        [Fact]
        ...
        [Theory]
        [InlineData("public class Class1")]
        [InlineData("public class TestAttribute : Attribute")]
        [InlineData("public static class Class3")]
        [InlineData("public abstract class Class4")]
        [InlineData("public sealed class Class5")]
        [InlineData("public class Class6<TParam>")]
        [InlineData("public class Class7<TParam1, TParam2>")]
        [InlineData("public interface Interface1")]
        [InlineData("public struct Struct1")]
        [InlineData("public readonly struct Struct2")]
        [InlineData("public interface Interface2<in TParam>")]
        [InlineData("public interface Interface3<out TParam>")]
        public void GetDefinition_returns_the_expected_definition_for_types(string expected)
        {
            // ARRANGE
            var cs = $@"
                using System;               
            ...
            var type = assembly.MainModule.Types.Single(x => x.IsPublic);

            // ACT / ASSERT
            Assert.Equal(expected, CSharpDefinitionFormatter.GetDefinition(type));
        }

        [Fact]
        public void GetDefinition_returns_the_expected_definition_for_types_that_includes_interface_implementations_and_base_classes()
        {
            // ARRANGE
            var cs = @"
                using System;
                ...
                public class Class2 : IDisposable, IEnumerable
                {
                    public void Dispose() => throw new NotImplementedException();
                ...
                public class Class5 : Class3, IDisposable, IEnumerable
                {
                    public void Dispose() => throw new NotImplementedException();
                ...
                public interface Interface1 : IDisposable, IEnumerable
                { }

                public struct Struct1 : IDisposable, IEnumerable
                {
                    public void Dispose() => throw new NotImplementedException();
            ...
            var class5 = assembly.MainModule.Types.Single(x => x.Name == "Class5");
            var interface1 = assembly.MainModule.Types.Single(x => x.Name == "Interface1");
            var struct1 = assembly.MainModule.Types.Single(x => x.Name == "Struct1");

            // ACT / ASSERT
            Assert.Equal("public class Class1 : IDisposable", CSharpDefinitionFormatter.GetDefinition(class1));
            Assert.Equal("public class Class2 : IDisposable, IEnumerable", CSharpDefinitionFormatter.GetDefinition(class2));
            Assert.Equal("public class Class4 : Class3", CSharpDefinitionFormatter.GetDefinition(class4));
            Assert.Equal("public class Class5 : Class3, IDisposable, IEnumerable", CSharpDefinitionFormatter.GetDefinition(class5));
            Assert.Equal("public interface Interface1 : IDisposable, IEnumerable", CSharpDefinitionFormatter.GetDefinition(interface1));
            Assert.Equal("public struct Struct1 : IDisposable, IEnumerable", CSharpDefinitionFormatter.GetDefinition(struct1));
        }

        [Fact]
        public void GetDefinition_omits_the_extension_attributes_for_types_that_define_extension_methods()
        {
            // ARRANGE
            var cs = @"
                using System;
        ...
        [Fact]
        public void GetDefinition_returns_expected_definition_for_types_with_attributes()
        {
            // ARRANGE
            var cs = @"
                using System;
                ...
                [Test2(TestEnum1.Value1 | TestEnum1.Value2 | TestEnum1.Value3)]
		        public class Class3
                { }
        ...
        [Fact]
        public void GetDefinition_returns_expected_definition_for_enum_types()
        {
            // ARRANGE
            var cs = @"
                using System;
            ...
            var enum1 = assembly.MainModule.Types.Single(x => x.Name == "Enum1");
            var enum2 = assembly.MainModule.Types.Single(x => x.Name == "Enum2");
            var enum3 = assembly.MainModule.Types.Single(x => x.Name == "Enum3");
