...
namespace Grynwald.MdDocs.Common.Test.Configuration
{
    public class CommandLineHelpConfigurationTest : IDisposable
    {
        ...
        {
            // ARRANGE            
            PrepareConfiguration("commandlinehelp:includeAutoGeneratedNotice", includeAutoGeneratedNotice);
        ...
        {
            [ConfigurationValue("mddocs:commandlinehelp:includeAutoGeneratedNotice")]
