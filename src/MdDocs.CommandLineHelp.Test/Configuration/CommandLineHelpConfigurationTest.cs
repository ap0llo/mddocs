...
namespace Grynwald.MdDocs.Common.Test.Configuration
{
    public class CommandLineHelpConfigurationTest : IDisposable
    {
        ...
        public static IEnumerable<object[]> DefaultConfigAssertions()
        {
            ...
            yield return TestCase(config => Assert.Equal(CommandLineHelpConfiguration.TemplateName.Default, config.Template.Name));
        ...
        {
            // ARRANGE            
            PrepareConfiguration("commandlinehelp:template:default:includeversion", includeVersion);
            ...
            Assert.Equal(includeVersion, config.Template.Default.IncludeVersion);
        }

        private class TestClass1
        {
            [ConfigurationValue("mddocs:commandlinehelp:template:default:includeversion")]
        ...
        {
            // ARRANGE            
            PrepareConfiguration("commandlinehelp:template:default:markdownPreset", preset.ToString());
        ...
        {
            // ARRANGE            
            PrepareConfiguration("commandlinehelp:template:default:includeAutoGeneratedNotice", includeAutoGeneratedNotice);
        ...
        {
            [ConfigurationValue("mddocs:commandlinehelp:template:default:includeAutoGeneratedNotice")]
        ...
        {
            // ARRANGE            
            var settings = new TestClass8() { IncludeAutoGeneratedNotice = includeAutoGeneratedNotice };
